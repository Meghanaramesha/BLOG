# User Acquisition Fundamentals: Web2 vs Web3 â€“ Matej Lancaric: User Acquisition Expert to Grow Mobile Games Globally ðŸ¦„ðŸ•º

![User Acquisition of Web2 vs User Acquisition of Web3](https://lancaric.me/wp-content/uploads/2023/05/RR_Metaverse_02.jpg-1024Ã—576.png) 
...
* Can you use the â€œold web2â€ UA framework?
...
â€œCurrently, launching and scaling a web3 game is mostly done via Discord, the community management platform, and through PPC web advertising on platforms like Facebook, Google AdWords.
...
Often the marketing beats that utilize these promotional channels are organized around pre-release token sales for in-game assets and at game launch, but few web3 games run the type of performance marketing common to the mobile free-to-play gaming category, which is referred to as user acquisition.â€
...
Traditional UA â€“ facebook, google, adnetworks, tiktok
...
There is no one single definition for what a web3 guild is, theyâ€™re generally considered to be a collective of crypto-enabled developers, designers, and thinkers that share resources (be it knowledge or labour) in the pursuit of a common goal.

In a way, you can think of web3 guilds like craft-specific DAOs where members work together and contribute to projects.

**As they do so, they earn financial rewards/equity in the organization in the form of tokens.**Â P2E gaming guilds are unique in that instead of bringing together people to work together on projects, members of P2E guilds likeÂ [**Guildfi**](https://guildfi.com/)Â andÂ [**Yield Guild**](https://yieldguild.io/)Â contribute by playing blockchain-based games (e.g., Axie Infinity) together; sharing earnings, rewards, and crypto knowhow in the process.
...
RTFKT Studios and Nike have finally released their first NFT with the â€œMNLTHâ€ drop. Airdropped exclusively to Clone X and PodX holders, the NFT is as ominous as it was heavily anticipated.
...
I guess the only difference is, you canâ€™t sell Ninja for 30k.

> [ZobraziÅ¥ tento prÃ­spevok na Instagrame](https://www.instagram.com/tv/CZl5dXWKkBw/?utm_source=ig_embed&utm_campaign=loading)
>
> [PrÃ­spevok, ktorÃ½ zdieÄ¾a RTFKT Studios (@rtfktstudios)](https://www.instagram.com/tv/CZl5dXWKkBw/?utm_source=ig_embed&utm_campaign=loading)
...
>
> â€” DeFi Vader (@DeFiVader) [February 14, 2022](https://twitter.com/DeFiVader/status/1493180376696688641?ref_src=twsrc%5Etfw)

> 3/ On the LTV side, in addition to 2 existing Axie revenue sources of breeding + marketplace fees. Iâ€™d also assume that IAPs (non-monetary items) would be paid in SLP and then be burnt. One needs to carefully balance/optimize the LTV and the economic sustainability.
>
> â€” DeFi Vader (@DeFiVader) [February 14, 2022](https://twitter.com/DeFiVader/status/1493180380547059714?ref_src=twsrc%5Etfw)

> 5/ Economy/tokenomics design itself is a product that is as crucial as the gameplay. A good design of P2E/NFT rewards can increase LTV (ownership vs expenditure â€œfeelingâ€) and decrease CAC (conversion, wom) while a bad one can result in an unsustainable ponzinomics model.
>
> â€” DeFi Vader (@DeFiVader) [February 14, 2022](https://twitter.com/DeFiVader/status/1493180384120614913?ref_src=twsrc%5Etfw)

> 7/ Another important prod is the Discord server. A good Discord community that makes players feel like â€œhomeâ€ and subconsciously provides desirable emotions can flourish. This wonâ€™t help with widening the top of the funnel but will help with conversion (CPI) and engagement (LTV).
>
> â€” DeFi Vader (@DeFiVader) [February 14, 2022](https://twitter.com/DeFiVader/status/1493180387358654471?ref_src=twsrc%5Etfw)
...
>
> â€” DeFi Vader (@DeFiVader) [February 14, 2022](https://twitter.com/DeFiVader/status/1493180388977655813?ref_src=twsrc%5Etfw)
