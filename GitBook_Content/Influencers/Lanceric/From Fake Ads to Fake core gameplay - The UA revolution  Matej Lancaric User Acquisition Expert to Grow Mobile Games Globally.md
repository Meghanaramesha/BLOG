# From Fake Ads to Fake core gameplay - The UA (r)evolution â€“ Matej Lancaric: User Acquisition Expert to Grow Mobile Games Globally ðŸ¦„ðŸ•º

![From Fake Ads to Fake core gameplay - The UA (r)evolution](https://lancaric.me/wp-content/uploads/2023/05/1024x576.png) 

# From Fake Ads to Fake core gameplay â€“ The UA (r)evolution
...
This again evolved itself as it first started as an attempt to **prolong the illusion that the game is the same as the fake ads**. This was done rather crudely through â€œduct tapingâ€ the **fake ads into the onboarding funnel** between the levels where fake ads playables were played by the user and then the real core gameplay of the game would be inserted in between.
...
Hero Wars uses fake ads to attract players by showcasing exaggerated or misleading gameplay elements that donâ€™t actually appear in the game. Hero wars pushes the first playable of a fake ad right from the start of the game, therefore the transition from the store that is full of screenshots of this fake ad seems seamless. User wonâ€™t notice any fake advertising immediately.
...
The illusion is now complete as the player at this phase still expects that the fake ad puzzles will show up somewhere between the levels as they did before (spoiler they wonâ€™t :D) so he continues playing. **The legend says this player is still waiting for more puzzles in the game ..**
...
Fake ads can have a significant impact on both mobile game gameplay and player experience, often creating a disconnect between expectations and reality.Mighty Party is a turn-based strategy RPG that is an excellent example of combining action, strategy, battle rpg and turn-based roleplaying games. We took the best from different genres to create an amazing experience for you in the world of Massively Online Role-Playing Games. The whole history of Mighty Party fake ads is written [here](https://lancaric.me/fake-ads-in-user-acquisition-the-untold-story/), so I wonâ€™t bother you too much. **Few highlights:**
...
Fully Tower fake and the last one looks almost the same as Hero wars.Â Lets look how the store looks like!
...
What was the tutorial evolution? This is the original gameplay with the default tutorial from the days when they didnâ€™t run any fake ads:

Here we have the â€œfake ad tutorialâ€ iteration:
...
But there are **games that evolved this trend** even further by actually building the **â€œfake core gameplayâ€** into the game and making it significant in the early stages of the game.
...
Letâ€™s look at the most recent examples and pioneers in this trend. Do you know which games are we talking about? NO?
...
## What impact do fake ads have on Kingdom Guardâ€™s user acquisition?

Fake ads have had a notable impact on Kingdom Guardâ€™s user acquisition by driving a large volume of installs, although they come with both positive and negative consequences. Kingdom Guard from Tap4free starts as a very simple merge game that has an auto-battling tower defense on the background.

Itâ€™s very easy, actually it uses somehow similar layout design to merge planes.
...
Sound like an interesting tower defense concept? WRONG!!! Letâ€™s see what happen next.
...
This is the time when the game introduces the classic **4X march battle map** and in the end unmasks itâ€™s true core gameplay which is the classic 4X game of upgrading buildings and battling players on the server map.

You still canâ€™t use all of the features as those are level-locked based on you tower defense level progression, which works nicely as a pacing mechanism for unlocking of the features once you hit the current merge cap on your towers.

One of the things where this illusion breaks a **little is the overall gold amounts that you have**. *(this is the geek game design Jakub talking about because I wouldnâ€™t notice shit!)*
...
The main focus of the game switches to getting resources from the march battle map and upgrading your base, where the gold amounts are actually relevant. This is the real game that has now taken over. The tower defense part just loses its use and you can just go and get some **â€œmergingâ€ dopamine** from there.
...
I am glad you asked! You are awesome. Kingdom Guard uses a lot of fake ads showing mostly the â€œcoreâ€ tower defense. Taking [inspiration also from hypercasual genre.](https://lancaric.me/creative-framework-in-the-post-idfa-world/)
...
Fake ads in mobile gamesâ€”ads that misrepresent the actual gameplay by exaggerating or fabricating featuresâ€”can have significant effects on user acquisition and retention.
...
Top war UA & creative team is mastering the hypercasual visuals and game mechanics integration into their gameâ€™s creative. Just look below:
...
There is actually plenty more, but you get it by now. Right? I see you are shaking your head. Here you are another super fake creative example. But thatâ€™s it. No more!
...
Have you seen the pattern here? No? Okay, letâ€™s unpack a little bit.
