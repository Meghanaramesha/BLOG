...
Telegram  
 ...
 Matej LančaričUA Mobile Growth Extraordinaire · Helping you stay 2.5 steps ahead of the games industry. Don't be too serious, except about UA.Subscribe to my Brutally Honest newsletter!
...
Playable Ads are not as easy to create as a static image. Do not expect to create a complicated brief and than be angry that your ad takes long to develop and is expensive and you need to export lot of assets.
Playable Ads don’t have to copy your game. So you use 30 AI generated videos and 100 AI generated images, with all different hooks that work but are irrelevant to your game, but for playables you want 100% gameplay? See where I am going here? Use that open mind in Playable Ads as well.
3D games = 3D playables = bigger budgets. Playable Ads need to be optimized carefully to fit requirements and with 3D games, it is no fun. Or use similar approach as in previous point – be open minded and focus on the theme rather than achieving 100% original gameplay.
You found a contractor for you playable ad, you are taking 3 weeks to approve concept and budget, 2 weeks to gather all assets(and still some missing), yet you expect your contractor to start working tomorrow and deliver on time. Understand companies that develop custom playables need your hand mostly in the beginning, if you do not give the right tools at the right time, you are the bottleneck.
One playable ads is NOT all you need. Those days are gone, when you developed a perfectly nice looking playable, put it in your campaign and magically you were winning. Playables are another part of your campaign mix, and same as videos, images, playables need to be produced at scale, compared, iterated and produced again.
...
Playable ads gained popularity in 2010 and eventually became mainstream-ish by 2018. Although the concept of playable ads is widely known, only 7% of mobile gaming app advertisers utilize it today. More specifically, playable ads are only used in 1% of RPG ads, 13% in Hypercasual, and 9% in shooting games.
...
They’re cost-friendly to run. On Android, playables are one of the cheapest to run on ($0.60) and run at less than half the cost of native ads ($1.22).
...
Intro: a brief graphic or video that captures the user’s attention
Tutorial: a quick visual explanation of how to play the game. Some apps show a quick video tutorial or use on-screen elements like arrows, prompts, or pointers.
Key gameplay mechanic: the interactive element where users can play the game.
Feedback: rewards, points, and indicators of win or loss
Call-to-Action (CTA): something to compel the user to install and continue playing
...
Combination of taps/and interactions – one tap, video+end card, multiple interactions…

The video format is easier to produce and may be lighter weight, but the HTML5 version is often more visually appealing and accurate to the product and is responsive. Learn more about types.
...
​You can find powerful MRAID validator here for free
...
For more details, you might find this helpful: Mintegral has well-documented requirements (specific to their platform). You can check them here:https://www.mindworks-creative.com/review/doc
...
Applovin
Applovin is the holy grail, or holy mother of playables. You want to get results on Applovin? You NEED playable ads. They also offer great preview tool –  so you can easily check your playables before you use them. 
Meta (Facebook) Ads
...
Show progress with visual progress bars, racking up points, leaderboards, or cues that indicate milestones motivate users to complete the game. The psychology of points systems, is one that mobile games take advantage of all the time, so why not use it here?
...
Low-quality apps can’t be saved
...
Don’t bother with apps with small target audiences
...
Subscribe to Brutally Honest Newsletter
 ...
 Matej LančaričUA Mobile Growth Extraordinaire · Helping you stay 2.5 steps ahead of the games industry. Don't be too serious, except about UA.Subscribe to my Brutally Honest newsletter!♻️ Sharing is caring! 🫶
LinkedIn
Twitter 
Reddit 
Facebook  
