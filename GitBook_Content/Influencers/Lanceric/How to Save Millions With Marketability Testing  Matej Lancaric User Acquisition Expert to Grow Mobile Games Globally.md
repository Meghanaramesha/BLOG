# How to Save Millions With Marketability Testing â€“ Matej Lancaric: User Acquisition Expert to Grow Mobile Games Globally ðŸ¦„ðŸ•º
...
Doing an internal analysis could prove to be very useful in getting your game in front of the right audience. Letâ€™s talk more about how to do it.
...
Who are your gameâ€™s 3-5 biggest competitors? We are looking here to match your game with other games in the same genre, with the same mechanics, done in the same style or art direction, and that have similar pricing or business models.

![](https://lancaric.me/wp-content/uploads/2021/07/lancaric-money-6.png)

Spreadsheet is done, we need to find out more about the competitorâ€™s demographics, interests and behaviors.

### 2. Mine and collect the demographics and interests of those 3 games in your spreadsheet

Demographics are the age, gender, and race of players. Interests are, well, categories or things theyâ€™re interested in. And behaviors are activities they do either online or offline.

For example, again using the above mentioned Candy Crush Saga illustration, and having already talked about their demographics, their interests would be things such as other games by King, womenâ€™s health brands, and the Hallmark Channel. And their behaviors would be things such as dining out, buying pet products, and clicking mobile ads.
...
Once you arrive on the Audience Insights page, youâ€™ll notice the general demographics and interests for all of Facebook have already been pre-populated. But we want to narrow that data down by interest. On the left-hand side of the screen youâ€™ll notice a section appropriately named, â€œInterestsâ€. Start typing â€œCandy Crush Sagaâ€ in that input box

### 3. Analyze the data, identify the overlaps, and draft a target audience profile for your game

Now that your work is done, itâ€™s time to start analyzing your data for overlaps. You should be able to pretty much eyeball it, especially if you were able to find 3 or 5 solid competing games. The overlap should be pretty clear. However, if the game youâ€™re making is a more unique game, or unlike much thatâ€™s out there, then connecting the dots with your data is probably going to be more difficult.

It can be easy to think that people who play games belong to one of two groups â€“ **hardcore** gamers living and breathing complex highly skilled games playing for 8 hours a day, and **casual gamers** playing low skill, non challenging games, playing them for 20 minutes a day. These extreme cases are also associated with a range of demographic assumptions and stereotypes. Like hardcore gamers being young and male, and casual gamers being old and female. The reality is that a majority of players fall somewhere between these two extremes on the game genre spectrum.
...
**Be concret**e: Articulate how a feature will change specific aspects of these playersâ€™ experience, and why that is important to them.

**For example** â€“ Golf Clash added the competitive PvP Meta from Clash Royale into the sports genre. This worked out because it was targeting competitive older (30-50 years old) males, which overlapped with the feature of Clash Royale.
...
**Letâ€™s take a look at PokÃ©mon Go**. PokÃ©mon Go is a great example of something fresh and original utilizing a great IP. Location-based games existed prior to PokÃ©mon Go, but the idea of going out into the real world to â€œcatch â€™em allâ€ is the realization of every PokÃ©mon fanâ€™s dream. And the market data expresses that this was a perfect fit. To date, PokÃ©mon Go remains one of the highest-grossing games on mobile.Google unwittingly [planted the seed for Pokemon Go](https://www.cbc.ca/news/technology/pokemon-google-origins-1.3690769) in the year 2016 in one of the many April Foolsâ€™ Day jokes the internet company is famous for. This could be understood to some degree as a Pokemon Go concept testing.

The other benefit of **concept testing** is its flexibility. To enhance your learnings, you canÂ  use surveys. To obtain player feedback you can create a redirect on the test app store page that directs people to a survey. These questions can cover game mechanics, characters, feature set, core loop, monetisation, spending behaviour, how often players play games and more. These survey questions are invaluable to:
...
If youâ€™re having trouble coming up with questions, it often helps to establish an overall goal for your survey. Think about the purpose of the test and the specific details you want to learnÂ  from respondents. This will help you create questions that are meaningful and provide unique insights into the playersâ€™ perspective.

### 2. Create a Consistent Structure

Questions that are related to each other should be grouped together on your survey. This creates a smoother flow making it easier to answer questions. Players wonâ€™t have to constantly shift their attention and can produce more detailed responses since theyâ€™re focused on one aspect of your idea.

### 3. Include Likert Scales

Likert Scales ask participants to rank their opinions on a five- or seven-point scale ranging from â€œstrongly agreeâ€ to â€œstrongly disagree.â€ This creates a consistent structure to your survey which makes it easier to analyze results. And, your team can use feedback collection tools with this type of data to automate their reporting. Plus, most people are familiar with Likert Scales making your survey user-friendly for participants.

### 4. Include Demographic Questions

Like with any other survey, youâ€™ll want to know whoâ€™s participating and whether they fit your target audience. Just because a participant says they disliked your concept doesnâ€™t mean your idea is bad. That participant may not be your ideal customer and therefore, isnâ€™t interested in your offer. This makes it important to include demographic survey questions to determine if your idea will be effective with your customer base.

### BONUS TIP

Try to be neutral and donâ€™t fall for the confirmation bias, as this is the downfall of most of the surveys. Even a small change in a questionâ€™s wording can affect how people search through available information, and hence the conclusions they reach.

## What are the Examples of Concept Testing Survey Questions?

**What did you like about the gameâ€™s tutorial?**

* This is a suggestive question, you will get positive answers

**How did you feel about the gameâ€™s tutorial?**
...
1. 1. 1. Train driver
      ...
      3. Train architect
      4. Ticket collector
      5. I wouldnâ€™t like a job in a train company
...
1. 1. 1. No, not at all
      ...
      3. Yes, but we donâ€™t play together
...
Concept testing is a process that almost any business can perform. Letâ€™s discuss some of the ways you can use it to evaluate ideas at your company. Not only in mobile games!
...
There are many different styles of art: pixel art, low poly, cartoon, serious and more. The gameâ€™s art style tells the player a lot about the game. When someone sees Bugs Bunny for the first time; they can tell by the art that the show is intended for kids. Itâ€™s important to think about your target audience when considering which art styles to test.

As a general rule, the more casual the game looks, the cheaper it is to acquire users. Just take a look at the hypercasual market! So even within the 4 main categories (hypercasual, casual, mid core & hardcore) there is still a huge range! **CPI testing is much better than CTR testing to determine a mobile gameâ€™s marketability.**

Speaking about marketability, **IPM, or the number of installs generated for every thousand impressions**, is a lesser known metric which is often overlooked by marketing teams. But in fact, itâ€™s critical for UA managers looking to evaluate the performance. IPM speaks to the **marketâ€™s response to a game**. For example, if a [user acquisition](https://lancaric.me/what-is-user-acquisition-and-why-should-i-care/)campaign for Game No.1 generates an IPM of 3.5 and a campaign for Game No.2 generates an IPM of 25, we can conclude from this result that your target audience prefers Game 2. This exercise will give you an idea about how the art style/theme resonates with your target audience. **This exercise will not tell you how your game will monetise and what your ROAS are going to be**.
...
My personal preference is using [Facebook ads to drive traffic](https://www.facebook.com/business/help/1438417719786914?id=802745156580214) for concept testing. Itâ€™s not only because of targeting! But to be honest, you can target almost everybody on Facebook â€“ both age and gender to be sure your art is appealing to your target audience. If you run a test without targeting and get great CTRs on some super awesome looking art, but the game is meant to be for males, then your test results arenâ€™t very helpful.
...
*Target audience â€“ US, Male 35+, train enthusiasts*

![](https://lancaric.me/wp-content/uploads/2021/07/TS2-Art-Test.jpg)

Concept testing lets studios test out any idea before releasing it to their customer base. While you might think your idea is incredible at the end of the day itâ€™s your players that decide if it is or not. If they donâ€™t like it during testing, theyâ€™re not going to like it in mass production. By testing the idea beforehand, your company can avoid launching ineffective and unsuccessful mobile games. Letâ€™s take a look at how you find out if the concept is not resonating well with your target audience

If you already have a game you can **get the real** Cost Per Installs (CPI), along with Click Through Rate (CTR) & Conversion Rate (CVR). If you donâ€™t have a game you can only get CTR. To be clear, the **main KPI** is Click Through Rate, because Conversion Rate can be influenced and improved by proper ASO (strategy).
...
* Create ads on Facebook using your [creatives](https://lancaric.me/creatives-framework-deep-dive/). Give them the same copy and send them to the same app (make sure to use an app that doesnâ€™t bias one over another).
...
Itâ€™s important to note that for statistical significance for CPI, your goal is the number of clicks, whereas for CTR itâ€™s the number of impressions.
...
You can try to calculate the â€œpredicted CPIâ€ (pCPI) with the numbers you already have:
...
In a system where CPIs are low, games can grow fast. If youâ€™re able to spend $1 and make $1.50 back then you should just keep spending more money and grow faster.
...
5 screenshots each including descriptions of the gameâ€™s mechanics/features. Depending on the game format (landscape/portrait)

â€“ 1125 x 2436 pixels (portrait)

â€“ 2436 x 1125 pixels (landscape)

**Create at least 3 Reviews of the Game each with 4 or 5 stars**

**Reviewer Names** â€“ avoid names like John Doe, use real names!
...
Resolution â€“ 1200 x 628 pixel and 1080Ã—1080

Ratio â€“ 1.91:1 and Square 1:1

**Ideally no text in banners**

**Copytext:**

Text â€“ 90 characters

Headline â€“ 25 characters

Link descriptionâ€“ 30 character
...
Resolution â€“ 720p at minimum

File size â€“ 2.3 GB maximum

Ideal length â€“ max 30 sec.
...
Every player is unique and special, with their own motivations for playing any game and developing a personalized approach to its ecosystem. However, itâ€™s nearly impossible to assess and cater to each type of personality with every aspect of your game, so itâ€™s necessary to step back, organize, and plan things out a bit. And that starts by understanding what youâ€™re dealing with in regard to your target audience.

There are many methods of demographic, psychographic, geographic and behavioralÂ [data collection](https://lancaric.me/building-a-data-driven-creative-framework/). There are quantitative methods, being statistical processes such as surveys and questionnaires, and qualitative methods, being in-depth approaches such as focus groups or comprehensive interviews. There are several companies that specialize in target audience research. For the game developers that are not able to work with these companies, there are ways to squeeze the most out of the free tools.
