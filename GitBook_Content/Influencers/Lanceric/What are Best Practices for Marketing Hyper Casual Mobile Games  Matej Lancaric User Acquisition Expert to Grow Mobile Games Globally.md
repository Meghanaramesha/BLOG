# What are Best Practices for Marketing Hyper Casual Mobile Games? â€“ Matej Lancaric: User Acquisition Expert to Grow Mobile Games Globally ðŸ¦„ðŸ•º
...
**Broad**Â â€“ These ad sets generally target entire countries or regions, and are typically split into female only and male only ad sets due to LTV spread by gender

**Precise Interest**Â â€“ Target direct competitor apps and similar apps within the genre. Aim to layer on many interests (5-10) to reach a relatively broad audience

**LAL**â€“ Utilize a seed audience of high valued users (high % of Ad Click or Ad Impressions, highly engaged users, highly retained users, etc..)

**Placements**Â â€“ Serve all placements using placement optimization to maximize your delivery efficiency

**Ads**Â â€“ Upload ads to serve all available placements
...
But, Iâ€™ve tested multiple targeting structures from interests to lookalikes, but eventually broad targeting for specific GEO outperformed everything else. Hypothesis was that lookalikes or interests will have higher CPI, but also higher LTV. But it wasnt true at all. LTV was the same with the CPI higher, so almost zero margins.

So again, I am writing it down because it was heavily tested by me and my clients, but when it comes down to best performing targeting â€“Â **its always broad targeting without any interests or lookalikes.**

**EXAMPLE:**

> 1 CAMPAIGN â€“ (GEO = US)  
> : ADSET no.1 â€“ 13+ MALE ($250 â€“ 500/daily)  
> \_\_\_ 4-6 ads  
> : ADSET no.2 â€“ 13+ FEMALE ($250 â€“ 500/daily)  
> \_\_\_ 4-6 ads

## What are the Best Practices for Setting Up Campaign Tiers Based on eCPMâ€™s?

The Best practices for setting up campaign tiers based on eCPMâ€™s are as followed:

1. Identify the topÂ countries from your worldwide campaign based on your eCPMâ€™s (excluding core markets youâ€™ve already separated out), and create Tier 1
...
Effortless monetization refers to generating revenue seamlessly within a mobile game, often by integrating non-intrusive ads or in-app purchases that donâ€™t disrupt gameplay. For hyper casual mobile games, this typically involves displaying short video ads, rewarded ads, or interstitials at natural breakpoints, allowing developers to earn from ad impressions or player engagement without compromising the quick, addictive nature of the game, thus maintaining user retention while maximizing monetization.
...
Cross-promotion is a marketing strategy where two or more products promote each other to reach a wider audience. For hyper casual mobile games, cross-promotion works by advertising one game within another game from the same developer or publisher, allowing users who enjoy similar gameplay to discover new titles easily. This strategy leverages existing user interest and familiarity with the developerâ€™s style, increasing the chances of higher installs and engagement across multiple games within the developerâ€™s portfolio.

## Influencer Collaborations

Influencer collaborations involve partnering with social media personalities to promote a product or service to their audience. For hyper casual mobile games, influencers showcase gameplay in short, engaging videos or livestreams, helping to boost visibility and drive downloads by leveraging their followersâ€™ trust and interest in easily accessible, quick-play games.
...
App Store Optimization (ASO) is the process of improving an appâ€™s visibility and ranking in app store search results to drive more downloads. For hyper casual mobile games, ASO works by focusing on keywords, appealing visuals, and enticing descriptions that grab attention quickly, as these games rely on high download volumes and rapid engagement. By optimizing for frequently searched terms and highlighting easy-to-understand gameplay in the app icon, screenshots, and video previews, ASO helps hyper casual games attract a larger audience and achieve higher rankings in app stores.

## Social Media Marketing

Social media marketing is the process of promoting products or services on social platforms to engage audiences and drive brand awareness. For hyper casual mobile games, it works by creating eye-catching, quick-to-grasp contentâ€”often through video ads or gameplay snippetsâ€”that appeals to a broad audience, encouraging downloads by showcasing easy-to-play, addictive gameplay. Social media ads, especially on platforms like Facebook and Instagram, allow hyper casual game developers to reach a vast user base quickly, testing and scaling campaigns based on real-time engagement and conversion data.
...
* Broad audiences need more creative than smaller audiences.Â **Aim to have >5 ads** per adsetsÂ when targeting broad audiences
